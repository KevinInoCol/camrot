...
class BVHBroadcaster(BVHReader):
    def __init__(self, filename, root_frame):
        ...
        # Posicion y rotacion para la transformacion de "map" a "world" usando tus valores ********************************************************************************************************
        self.translation = (0.0, 0.0, 0.0)  # Valores x, y, z de la posicion *********************************************************************************************************************
        self.rotation = tf.transformations.quaternion_from_euler(1.57, 0.0, 1.57)  # Valores yaw, pitch, roll convertidos a cuaterniones ***********************************************************
    ...
    def broadcastRootJoint(self, root, parent_frame):
        ...
        # Publicar la transformacion de `map` a `world` usando la posicion y rotacion especificadas **************************************************************************************************
        self.br.sendTransform(self.translation, self.rotation, rospy.Time.now(), "world", "map")
